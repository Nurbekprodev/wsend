<footer class="bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800">
    <div class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div class="md:flex md:justify-between gap-12">
            ...
            <!-- Logo + description -->
            <div class="mb-10 md:mb-0 md:max-w-xs">
                <a href="{{ url('/') }}" class="flex items-center hover:opacity-90 transition mb-4">
                    <img 
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-12 sm:grid-cols-3">
                ...
                <div>
                    <h2 class="mb-5 text-sm font-semibold text-gray-900 dark:text-white">
                        Product
                    </h2>
                    <ul class="space-y-3">
                        <li>
                            <a href="/" class="text-sm text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition">
                                Upload
                            </a>
                        </li>
                        <li>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex items-center gap-4">
                <a href="#" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition">
